...
State_trait_scale_1_data=pt_2_data[['unique ID','State-trait scale 1_1', 'State-trait scale 1_2', 'State-trait scale 1_3', 'State-trait scale 1_4',
...
State_trait_scale_1_data.columns = ['unique_ID']+[i for i in xrange(1,41)]

for col in list(State_trait_scale_1_data):
       State_trait_scale_1_data[col] = State_trait_scale_1_data[col].astype(float)

State_trait_scale_1_data.set_index('unique_ID',inplace=True)

# scoring:
# State_trait_scale_1_score=State_trait_scale_1_scoring(State_trait_scale_1_data)


##State_trait_scale_2 data
State_trait_scale_2_data=pt_2_data[['unique ID','State-trait scale 2_1', 'State-trait scale 2_2', 'State-trait scale 2_3', 'State-trait scale 2_4',
                                    'State-trait scale 2_5',
       'State-trait scale 2_6', 'State-trait scale 2_7', 'State-trait scale 2_8', 'State-trait scale 2_9', 'State-trait scale 2_10',
       'State-trait scale 2_11', 'State-trait scale 2_12', 'State-trait scale 2_13', 'State-trait scale 2_14', 'State-trait scale 2_15',
       'State-trait scale 2_16', 'State-trait scale 2_17', 'State-trait scale 2_18', 'State-trait scale 2_19', 'State-trait scale 2_20',
       'State-trait scale 2_21', 'State-trait scale 2_22', 'State-trait scale 2_23', 'State-trait scale 2_24', 'State-trait scale 2_25',
       ...
       'State-trait scale 2_36', 'State-trait scale 2_37', 'State-trait scale 2_38', 'State-trait scale 2_39',
       'State-trait scale 2_40']]

State_trait_scale_2_data.columns = ['unique_ID']+[i for i in xrange(1,41)]

for col in list(State_trait_scale_2_data):
       State_trait_scale_2_data[col] = State_trait_scale_2_data[col].astype(float)

State_trait_scale_2_data.set_index('unique_ID',inplace=True)

# scoring:
# State_trait_scale_2_score=State_trait_scale_2_scoring(State_trait_scale_2_data)
